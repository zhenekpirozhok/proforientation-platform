...
describe('useQuizDetails', () => {
    ...
    test('aggregates data and nulls', () => {
        ...
        useQuizMetricsMock.mockReturnValueOnce(makeQuery({ data: { questionsTotal: 5 } }));
        useCurrentQuizVersionMock.mockReturnValueOnce(makeQuery({ data: { id: 10 } }));
    ...
    test('isLoading is OR of all queries', () => {
        ...
        useCurrentQuizVersionMock.mockReturnValueOnce(makeQuery({ isLoading: false }));
